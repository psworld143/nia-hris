<?php
/**
 * ID Encryption Utility for NIA-HRIS
 * 
...
class IDEncryption {
    private static $key = 'NIA_HRIS_SECURE_KEY_2024'; // Change this to a secure key
...
/**
 * Encrypt an ID for URL use (alias for consistency)
 * 
 * @param int $id The ID to encrypt
 * @return string The encrypted ID
 */
function safe_encrypt_id($id) {
    return IDEncryption::encrypt($id);
}
?>
