...
WHERE prc.status = 'active'
ORDER BY prc.category_id, prc.order_number";
...
// Get attachments for this review
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900">Performance Review</h1>
                            <p class="text-gray-600 mt-2">View detailed performance evaluation and assessment</p>
                        </div>
