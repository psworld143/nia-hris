    ...
    <div class="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl shadow-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="opacity-90">Manage payroll periods, hours, deductions, and generate payslips</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="manage-payroll-deductions.php" class="bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                    <i class="fas fa-cog mr-2"></i>Manage Deductions
                </a>
                <a href="payroll-reports.php" class="bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                    <i class="fas fa-chart-bar mr-2"></i>Reports
                </a>
                <button onclick="openCreatePeriodModal()" class="bg-white text-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
