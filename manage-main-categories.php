            ...
            case 'add_main_category':
                ...
                if (empty($name)) {
                    ...
                    if ($check_row['count'] > 0) {
                        ...
                        $insert_query = "INSERT INTO main_evaluation_categories (name, description, evaluation_type, created_by, created_by_role) VALUES (?, ?, ?, ?, ?)";
                        $insert_stmt = mysqli_prepare($conn, $insert_query);
                        $user_role = $_SESSION['role'];
                        mysqli_stmt_bind_param($insert_stmt, "sssis", $name, $description, $evaluation_type, $_SESSION['user_id'], $user_role);
...
// Get main evaluation categories created by HR users only
$main_categories_query = "SELECT mec.*,
                         ...
                         WHERE mec.created_by_role IN ('human_resource', 'hr_manager')
                         GROUP BY mec.id
...
<div class="mb-6 sm:mb-8">
    <div class="flex items-center justify-between">
        ...
        <a href="evaluations-hr.php" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-2">
                                <a href="sub-categories.php?main_category_id=<?php echo safe_encrypt_id($category['id']); ?>"
                            ...
                            <a href="conduct-evaluation.php?main_category_id=<?php echo safe_encrypt_id($category['id']); ?>"
