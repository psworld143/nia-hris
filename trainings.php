    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo number_format($stats['total_trainings'] ?? 0); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo number_format($stats['published_trainings'] ?? 0); ?></p>
                <p class="text-xs text-green-600"><?php echo number_format($stats['ongoing_trainings'] ?? 0); ?> ongoing</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo number_format($stats['completed_trainings'] ?? 0); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo number_format(($stats['training_count'] ?? 0) + ($stats['seminar_count'] ?? 0) + ($stats['workshop_count'] ?? 0) + ($stats['conference_count'] ?? 0)); ?></p>
                <p class="text-xs text-orange-600"><?php echo number_format($stats['training_count'] ?? 0); ?> trainings, <?php echo number_format($stats['seminar_count'] ?? 0); ?> seminars</p>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-md p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <a href="export_trainings.php" class="bg-green-600 text-white px-3 py-2 rounded-lg hover:bg-green-700 transition text-sm">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="px-2 py-1 text-xs rounded-full <?php
                            echo $training['status'] === 'published' ? 'bg-green-100 text-green-800' :
                                ($training['status'] === 'ongoing' ? 'bg-blue-100 text-blue-800' :
                                ($training['status'] === 'completed' ? 'bg-gray-100 text-gray-800' :
                                ($training['status'] === 'cancelled' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800')));
                        ?>">
                            <?php echo ucfirst($training['status']); ?>
                        </span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <?php echo number_format($training['registered_count']); ?>/<?php echo $training['max_participants'] ?? '∞'; ?>
                        <?php if ($training['completed_count'] > 0): ?>
                        <br>
                        <span class="text-xs text-green-600"><?php echo number_format($training['completed_count']); ?> completed</span>
                        <?php endif; ?>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="view-training.php?id=<?php echo safe_encrypt_id($training['id']); ?>"
                               class="text-seait-orange hover:text-orange-600">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="edit-training.php?id=<?php echo safe_encrypt_id($training['id']); ?>"
                               class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="training-participants.php?id=<?php echo safe_encrypt_id($training['id']); ?>"
    ...
    <div class="text-center py-8">
        ...
        <p class="text-gray-500">No trainings found with the selected filters.</p>
    </div>
    <?php endif; ?>
</div>
